...
function searchData(){
	...
	$("#messageForm").hide();
	$.ajax({
		url:'${pageContext.request.contextPath }/subscribe/search_user?username='+encodeURI(preName),
		type:'post',
		dataType:'json',
		data:{},
...
<body>
	<div class="header">My Message Board</div>
	<ul>
	...
	<div class="board">
		<!-- <div class="search">
		<label>input other's username:</label>
		<input type="text" id="username" name="username"/>
		<a href="javascript:;" onclick="searchData();">search</a>
	</div> -->
